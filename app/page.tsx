  ...
  return (
    <div className={"flex-1 flex items-center justify-center"}>
      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className="max-w-[80%] max-h-[80%] overflow-y-auto sm:max-w-[825px] p-0">
          <div className={"min-h-[470px] grid sm:w-full sm:grid-cols-[45%_55%] "}>
            ...
            </div>
            {
              isConnecting ?
                ...
                :
                <div className={"py-4 px-8 flex flex-col justify-center items-center gap-8"}>
